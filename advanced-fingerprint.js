...
(function () {
    !function (e, t, a) {
        ...
        var d = function d(e, t) {
            ...
            c = function c(e, t) {
            if (Array.prototype.forEach && e.forEach === Array.prototype.forEach) e.forEach(t);else if (e.length === +e.length) for (var a = 0, n = e.length; a < n; a++) {
                t(e[a], a, e);
            } else for (var r in e) {
            ...
            getOscpu = function getOscpu(e) {
            return navigator.oscpu || 'not available';
        },
            getJavaEnabled = function getJavaEnabled(e) {
            return navigator.javaEnabled();
        },
            getAppVersion = function getAppVersion(e) {
            return navigator.appVersion;
        },
            getLanguages = function getLanguages(e) {
            return navigator.languages;
        },
            getVendor = function getVendor(e) {
            return navigator.vendor;
        },
            getVendorSub = function getVendorSub(e) {
            return navigator.vendorSub;
        },
            getPluginAvailable = function getPluginAvailable(e) {
            return void 0 !== navigator.plugins ? 1 : 0;
        },
            getAudioFormats = function getAudioFormats(e) {
            var audio = void 0;
            var audioFormats = ['audio/aac', 'audio/flac', 'audio/mpeg', 'audio/mp4; codecs="mp4a.40.2"', 'audio/ogg; codecs="flac"', 'audio/ogg; codecs="vorbis"', 'audio/ogg; codecs="opus"', 'audio/wav; codecs="1"', 'audio/webm; codecs="vorbis"', 'audio/webm; codecs="opus"'];
            var audioValues = {};
            if (!audio) {
            ...
            getVideoFormats = function getVideoFormats(e) {
            var video = void 0;
            var videoFormats = ['video/mp4; codecs="flac"', 'video/ogg; codecs="theora"', 'video/ogg; codecs="opus"', 'video/webm; codecs="vp9, opus"', 'video/webm; codecs="vp8, vorbis"'];
            var videoValues = {};
            if (!video) {
            ...
            getAudioParams = function getAudioParams(e) {
            ...
            getMediaDevices = function getMediaDevices(e) {
            var deviceValues = {};
            ...
            screenTop = function screenTop(e) {
            return window.screenTop;
        },
            screenLeft = function screenLeft(e) {
            return window.screenLeft;
        },
            getMimeTypes = function getMimeTypes(e) {
            var mimeTypes = [];
            for (var _i = 0; _i < navigator.mimeTypes.length; _i++) {
                var mt = navigator.mimeTypes[_i];
                mimeTypes.push([mt.description, mt.type, mt.suffixes].join("~~"));
            }
            return mimeTypes;
        },
            getMathConst = function getMathConst(e) {
            function asinh(x) {
                if (x === -Infinity) {
                    return x;
                } else {
            ...
            return [asinh(1), acosh(1e300) == "Infinity" ? "Infinity" : acosh(1e300), atanh(0.5), expm1(1), cbrt(100), log1p(10), sinh(1), cosh(10), tanh(1)];
        },
            getPermissions = function getPermissions(e) {
            var permissions = ['accelerometer', 'camera ', 'clipboard-read', 'clipboard-write', 'geolocation', 'background-sync', 'magnetometer', 'microphone', 'midi', 'notifications', 'payment-handler', 'persistent-storage'];
            ...
            var o,
                e = function e(_e) {
                return o.clearColor(0, 0, 0, 1), o.enable(o.DEPTH_TEST), o.depthFunc(o.LEQUAL), o.clear(o.COLOR_BUFFER_BIT | o.DEPTH_BUFFER_BIT), "[" + _e[0] + ", " + _e[1] + "]";
            };
            if (!(o = F())) return null;
            var l = [],
                t = o.createBuffer();
            ...
            getData: function getData(a, e) {
                ...
                var l = setTimeout(function () {
                    return console.warn('Audio error "' + navigator.userAgent + '".'), r.oncomplete = function () {}, r = null, a("audioTimeout");
                }, t.timeout);
