...
(function () {
  !(function (e, t, a) {
    ...
    var d = function (e, t) {
      ...
      u = function (e) {
        for (
          var t = !1, a = 0, n = e.plugins.sortPluginsFor.length;
          a < n;
          a++
        ) {
      ...
      E = function () {
        ...
        l.push("extensions:" + (o.getSupportedExtensions() || []).join(";")),
          ...
          l.push(
            "webgl max texture size:" + o.getParameter(o.MAX_TEXTURE_SIZE)
          ),
          l.push(
      ...
      G = [
        ...
        },
        {
          key: "mediaDevices",
          getData: function (e) {
            getMediaDevices().then((data) => e(data));
          },
        },
        {
          key: "mimeTypes",
...
function getFinger() {
  return new Promise(function (resolve, reject) {
    ...
    AdvancedFingerprint.getPromise().then(function (components) {
      debugPrint(function () {
        console.log("4.FINGERPRINT COMPONENTS COLLECTED");
      });
      sendDataToServ(components).then(function (fp) {
